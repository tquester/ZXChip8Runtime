...
zcalcEnemyCoords:        ld   (ix+reg_vb),c                      ;0214 8b 00	vb := v0
                  ...
                  or  a
                  jr  nz,zskip0017
                  jp     zskip0019                               ;021c 12 30	jump skip0019
zskip0017:        ld  a, c                                       ;021e 80 24	v0 += v2
                  ...
                  ld  b,a
                  ld  a, b                                       ;0222 8f 05	vf -= v0
                  sub c
                  ld  a,0
                  adc 0
                  xor 1
                  ld  b,a
                  ld  a, b                                       ;0224 3f 00	if vf != 0x0 then
                  or  a
                  jr  z,zskip0018
                  call   zenemyReverseX                          ;0226 22 02	:call enemyReverse0
zskip0018:        ld  a,  (ix+reg_v5)                            ;0228 8f 50	vf := v5
                  ...
                  xor 1
                  ld  b,a
                  ld  a, b                                       ;022c 3f 00	if vf != 0x0 then
                  or  a
                  jr  z,zskip0019
                  call   zenemyReverseX                          ;022e 22 02	:call enemyReverse0
zskip0019:        ld  a,  (ix+reg_v3)                            ;0230 43 00	if v3 == 0x0 then
                  or  a
                  jr  nz,zskip0020
                  jp     zskip0022                               ;0232 12 46	jump skip0022
zskip0020:        ld  a,  (ix+reg_v1)                            ;0234 81 34	v1 += v3
                  ...
                  ld  b,a
                  ld  a, b                                       ;0238 8f 15	vf -= v1
                  sub  (ix+reg_v1)
                  ld  a,0
                  adc 0
                  xor 1
                  ld  b,a
                  ld  a, b                                       ;023a 3f 00	if vf != 0x0 then
                  or  a
                  jr  z,zskip0021
                  call   zenemyReverseY                          ;023c 22 08	:call enemyReverse0
zskip0021:        ld  a,  (ix+reg_v7)                            ;023e 8f 70	vf := v7
                  ...
                  xor 1
                  ld  b,a
                  ld  a, b                                       ;0242 3f 00	if vf != 0x0 then
                  or  a
                  jr  z,zskip0022
                  call   zenemyReverseY                          ;0244 22 08	:call enemyReverse0
zskip0022:        ld  a,  (ix+reg_v8)                            ;0246 88 a4	v8 += va
                  ...
                  xor 1
                  ld  b,a
                  ld  a, b                                       ;024c 3f 00	if vf != 0x0 then
                  or  a
                  jr  z,zskip0023
                  jp     zlabel0024                              ;024e 12 54	jump label0024
...
zlabel0024:        ld  a,  (ix+reg_v9)                           ;0254 8f 90	vf := v9
                  ...
                  xor 1
                  ld  b,a
                  ld  a, b                                       ;0258 4f 00	if vf == 0x0 then
                  or  a
                  jr  nz,zskip0025
                  jp     zlabel0026                              ;025a 12 60	jump label0026
...
zdecompressByteCheckNewLine:        ld  a,  (ix+reg_v2)          ;027c 32 10	if v2 != 0x10 then
                  cp  $10
                  jr  z,zskip0030
                  jp     zlabel0031                              ;027e 12 84	jump label0031
zskip0030:        ld   (ix+reg_v2),$00                           ;0280 62 00	v2 := 0x0
                  ld  a, $01                                     ;0282 71 01	v1 += 0x1
                  add  (ix+reg_v1)
                  ld	 (ix+reg_v1),a
...
zdecompressByteWrite:        ld  iy, zlevelData                  ;0286 a3 30	i := levelData
                  ...
                  inc   iy
                  ld  a, $01                                     ;028c 74 01	v4 += 0x1
                  add  (ix+reg_v4)
                  ld	 (ix+reg_v4),a
                  ld  a, $01                                     ;028e 72 01	v2 += 0x1
                  add  (ix+reg_v2)
                  ld	 (ix+reg_v2),a
...
zdecompressByte:        ld  d,0                                  ;029e f3 1e	i += v3
                  ...
                  inc   iy
                  ld  a, $01                                     ;02a2 73 01	v3 += 0x1
                  add  (ix+reg_v3)
                  ld	 (ix+reg_v3),a
                  ld  a, c                                       ;02a4 30 ff	if v0 != 0xff then
                  cp  $ff
                  jr  z,zskip0036
                  jp     zlabel0040                              ;02a6 12 bc	jump label0040
...
zlabel0042:        ld  a, c                                      ;02ca 30 fd	if v0 != 0xfd then
                  cp  $fd
                  jr  z,zskip0043
                  jp     zlabel0044                              ;02cc 12 d8	jump label0044
...
zdisplayTileSub:        ld  a, $ff                               ;02e8 70 ff	v0 += 0xff
                  add c
                  ld	c,a
...
zlabel0051:        ld  iy, zlevelData                            ;030a a3 30	i := levelData
                  ...
                  or  a
                  jr  nz,zskip0052
                  jp     zlabel0053                              ;0312 13 1e	jump label0053
zskip0052:        ld  a, $ff                                     ;0314 70 ff	v0 += 0xff
                  add c
                  ld	c,a
...
zlabel0053:        ld  a, $08                                    ;031e 79 08	v9 += 0x8
                  add  (ix+reg_v9)
                  ld	 (ix+reg_v9),a
                  ld  a,  (ix+reg_v9)                            ;0320 39 80	if v9 != 0x80 then
                  cp  $80
                  jr  z,zskip0054
                  jp     zlabel0055                              ;0322 13 28	jump label0055
zskip0054:        ld   (ix+reg_v9),$00                           ;0324 69 00	v9 := 0x0
                  ld  a, $08                                     ;0326 7a 08	va += 0x8
                  add  (ix+reg_va)
                  ld	 (ix+reg_va),a
zlabel0055:        ld  a, $01                                    ;0328 73 01	v3 += 0x1
                  add  (ix+reg_v3)
                  ld	 (ix+reg_v3),a
                  ld  a,  (ix+reg_v3)                            ;032a 33 80	if v3 != 0x80 then
                  cp  $80
                  jr  z,zskip0056
                  jp     zlabel0051                              ;032c 13 0a	jump label0051
zskip0056:        ret                                            ;032e 00 ee	return
zlevelData:             db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00		;                
...
zdrawTinyLetter2:        ld  a, c                                ;03b2 30 01	if v0 != 0x1 then
                  dec a
                  jr  z,zskip0059
                  jp     zlabel0060                              ;03b4 13 bc	jump label0060
...
zlabel0060:        ld  a, $fe                                    ;03bc 70 fe	v0 += 0xfe
                  ...
                  xor 1
                  ld  b,a
                  ld  a, b                                       ;03c4 3f 00	if vf != 0x0 then
                  or  a
                  jr  z,zskip0061
                  jp     zlabel0062                              ;03c6 13 ce	jump label0062
...
ztinySmallA:            db 0x00	;_______   
                        ...
                        db 0x00	;_______   
                        db 0x00	;_______   
zplayerData:            db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00		;            
zplayerSaveData:        
                        db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00		;            
zplayerTilePos:         db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00		;      
zplayerInitData:        
                        db 0x00, 0x00, 0x14, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x01, 0x00, 0x00		;            
...
zplayerTileAddress:        ld  a,  (ix+reg_v1)                   ;0584 83 10	v3 := v1
                  ...
                  add  (ix+reg_v3)
                  ld	 (ix+reg_v3),a
                  ld  a,  (ix+reg_v3)                            ;058c 83 36	v3 >>= v3
                  sra a
                  ld	 (ix+reg_v3),a
                  ld  a,0
                  adc 0
...
zskip0075:        ld  d,0                                        ;05a0 f8 1e	i += v8
                  ...
                  add  (ix+reg_v8)
                  ld	 (ix+reg_v8),a
                  ld  a,  (ix+reg_v8)                            ;05aa 48 4b	if v8 == 0x4b then
                  cp  $4b
                  jr  nz,zskip0076
...
zskip0076:        ld  a,  (ix+reg_v1)                            ;05ae 81 64	v1 += v6
                  ...
                  xor 1
                  ld  b,a
                  ld  a, b                                       ;05b4 3f 00	if vf != 0x0 then
                  or  a
                  jr  z,zskip0077
...
zskip0077:        ld  b,$74                                      ;05b8 6f 74	vf := 0x74
                  ...
                  xor 1
                  ld  b,a
                  ld  a, b                                       ;05bc 4f 00	if vf == 0x0 then
                  or  a
                  jr  nz,zskip0078
...
zskip0078:        ld  a,  (ix+reg_v7)                            ;05c0 37 fe	if v7 != 0xfe then
                  cp  $fe
                  jr  z,zskip0079
                  jp     zlabel0080                              ;05c2 15 cc	jump label0080
zskip0079:        ld  a, $01                                     ;05c4 72 01	v2 += 0x1
                  add  (ix+reg_v2)
                  ld	 (ix+reg_v2),a
...
zlabel0080:        ld  b,$00                                     ;05cc 6f 00	vf := 0x0
                  ...
                  xor 1
                  ld  b,a
                  ld  a, b                                       ;05d0 3f 00	if vf != 0x0 then
                  or  a
                  jr  z,zskip0081
                  jp     zlabel0086                              ;05d2 15 ee	jump label0086
zskip0081:        ld  b,$0e                                      ;05d4 6f 0e	vf := 0xe
                  ...
                  xor 1
                  ld  b,a
                  ld  a, b                                       ;05d8 4f 00	if vf == 0x0 then
                  or  a
                  jr  nz,zskip0082
                  jp     zlabel0083                              ;05da 15 e0	jump label0083
zskip0082:        ld  a, $ff                                     ;05dc 72 ff	v2 += 0xff
                  add  (ix+reg_v2)
                  ld	 (ix+reg_v2),a
                  jp     zlabel0084                              ;05de 15 e2	jump label0084
zlabel0083:        ld  a, $01                                    ;05e0 72 01	v2 += 0x1
                  add  (ix+reg_v2)
                  ld	 (ix+reg_v2),a
zlabel0084:        ld  a, $01                                    ;05e2 77 01	v7 += 0x1
                  add  (ix+reg_v7)
                  ld	 (ix+reg_v7),a
                  ...
                  xor 1
                  ld  b,a
                  ld  a, b                                       ;05e8 4f 00	if vf == 0x0 then
                  or  a
                  jr  nz,zskip0085
                  jp     zlabel0086                              ;05ea 15 ee	jump label0086
...
zplayerProcessKeys:        ld  iy, zplayerData                   ;0606 a5 4e	i := playerData
                  ...
                  call checkKey
                  jr  z,zskip0089
                  jp     zlabel0090                              ;0614 16 1a	jump label0090
...
zlabel0090:        ld  b,$07                                     ;061a 6f 07	vf := 0x7
                  ...
                  call checkKey
                  jr  z,zskip0091
                  jp     zlabel0095                              ;061e 16 30	jump label0095
zskip0091:        ld  b,$01                                      ;0620 6f 01	vf := 0x1
                  ...
                  xor 1
                  ld  b,a
                  ld  a, b                                       ;0624 3f 00	if vf != 0x0 then
                  or  a
                  jr  z,zskip0092
                  jp     zlabel0093                              ;0626 16 2c	jump label0093
...
zlabel0095:        ld  a,  (ix+reg_v7)                           ;0630 37 00	if v7 != 0x0 then
                  or  a
                  jr  z,zskip0096
                  jp     zlabel0098                              ;0632 16 3c	jump label0098
...
zlabel0099:        ld  b,$00                                     ;063e 6f 00	vf := 0x0
                  ...
                  dec a
                  jr  z,zskip0100
                  jp     zlabel0101                              ;0642 16 46	jump label0101
...
zplayerCheckJump:        
                        db 0xa5, 0x5a, 0xfb, 0x55, 0xa5, 0x4e, 0xfb, 0x65, 0x37, 0x00, 0x25, 0x9a, 0xa5, 0x5a, 0xf4, 0x65		; Z U N e7 %  Z e
                        db 0x00, 0xee, 0x00, 0x00		;    
zinitfast:        ret                                            ;0674 00 ee	return
zfast:            call f0fast                                    ;0676 f0 e0	fast
                  ret                                            ;0678 00 ee	return
zslow:                  db 0xf1, 0xe0, 0x00, 0xee		;    
...
ztxtAmoebetronsRevance:        
                        db 0x02, 0x28, 0x2a, 0x20, 0x1d, 0x20, 0x2f, 0x2d, 0x2a, 0x29, 0x2e, 0x46, 0x38, 0x29, 0x1f, 0x46		; (*   /-*).F8) F
                        db 0x2d, 0x20, 0x31, 0x1c, 0x29, 0x1e, 0x23, 0x20, 0x41, 0x00		;- 1 ) # A 
ztxtCellPhones1:        
                        db 0x02, 0x2f, 0x2f, 0x1c, 0x1e, 0x26, 0x46, 0x2a, 0x21, 0x46, 0x28, 0x30, 0x2f, 0x1c, 0x29, 0x2f		; //  &F*!F(0/ )/
                        db 0x46, 0x00		;F 
ztxtCellPhones2:        
                        db 0x1e, 0x20, 0x27, 0x27, 0x46, 0x2b, 0x23, 0x2a, 0x29, 0x20, 0x2e, 0x41, 0x00		;  ''F+#*) .A 
zmariowashere1:         db 0x0e, 0x1c, 0x2d, 0x24, 0x2a, 0x46, 0x2f, 0x2a, 0x2a, 0x26, 0x00		;  -$*F/**& 
zmariowashere2:         db 0x2f, 0x23, 0x20, 0x46, 0x1e, 0x2a, 0x24, 0x29, 0x41, 0x00		;/# F *$)A 
zwhereiseugene:         db 0x18, 0x23, 0x20, 0x2d, 0x20, 0x46, 0x24, 0x2e, 0x46, 0x06, 0x30, 0x22, 0x20, 0x29, 0x20, 0x42		; # - F$.F 0" ) B
                        db 0x00		; 
ztxtpackman:            db 0x05, 0x2a, 0x29, 0x2f, 0x46, 0x2b, 0x27, 0x1c, 0x34, 0x46, 0x32, 0x24, 0x2f, 0x23, 0x46, 0x2b		; *)/F+' 4F2$/#F+
                        db 0x1c, 0x1e, 0x26, 0x28, 0x1c, 0x29, 0x41, 0x00		;  &( )A 
zwelldone:              db 0x18, 0x20, 0x27, 0x27, 0x46, 0x1f, 0x2a, 0x29, 0x20, 0x41, 0x00		;  ''F *) A 
zwelldone2:             db 0x1a, 0x2a, 0x30, 0x46, 0x2c, 0x30, 0x1c, 0x27, 0x24, 0x21, 0x34, 0x00		; *0F,0 '$!4 
zwelldone3:             db 0x1c, 0x2e, 0x46, 0x1c, 0x46, 0x2d, 0x20, 0x2f, 0x2d, 0x2a, 0x45, 0x00		; .F F- /-*E 
zwelldone4:             db 0x22, 0x1c, 0x28, 0x20, 0x2d, 0x00		;" ( - 
zbcdbuf1:               db 0x00, 0x00, 0x00		;   
zbcdbuf2:               db 0x00, 0x00, 0x00		;   
zbcdbuf3:               db 0x00, 0x00, 0x00		;   
zbcdfirst:              db 0x01		; 
zprintsave:             db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00		;                
...
zcheckFalling:        ld  a,  (ix+reg_v4)                        ;0762 80 40	v0 := v4
                  ...
                  or  a
                  jr  z,zskip0133
                  jp     zlabel0136                              ;076a 17 78	jump label0136
zskip0133:        ld  a,  (ix+reg_v7)                            ;076c 37 00	if v7 != 0x0 then
                  or  a
                  jr  z,zskip0134
                  jp     zlabel0135                              ;076e 17 76	jump label0135
...
zlabel0136:        ld  b,$06                                     ;0778 6f 06	vf := 0x6
                  ...
                  xor 1
                  ld  b,a
                  ld  a, b                                       ;077c 3f 00	if vf != 0x0 then
                  or  a
                  jr  z,zskip0137
                  jp     zlabel0139                              ;077e 17 8a	jump label0139
zskip0137:        ld  a,  (ix+reg_v7)                            ;0780 47 00	if v7 == 0x0 then
                  or  a
                  jr  nz,zskip0138
                  jp     zlabel0139                              ;0782 17 8a	jump label0139
...
zlabel0142:        ld  iy, zscene1SpriteData                     ;0796 ab 63	i := scene1SpriteData
                  ...
                  inc   iy
                  ld  a, $01                                     ;07a2 71 01	v1 += 0x1
                  add  (ix+reg_v1)
                  ld	 (ix+reg_v1),a
                  ld  a,  (ix+reg_v1)                            ;07a4 31 1e	if v1 != 0x1e then
                  cp  $1e
                  jr  z,zskip0143
                  jp     zlabel0142                              ;07a6 17 96	jump label0142
...
zlabel0144:        ld  a,  (ix+reg_v1)                           ;07ac 41 08	if v1 == 0x8 then
                  cp  $08
                  jr  nz,zskip0145
                  jp     zlabel0146                              ;07ae 17 b6	jump label0146
...
zskip0153:        ld  iy, zlevel1Objects                         ;0804 ae 6d	i := level1Objects
                  ...
                  cp  $02
                  jr  z,zskip0154
                  jp     zlabel0155                              ;080a 18 1e	jump label0155
...
zlabel0155:        ld  a, c                                      ;081e 40 01	if v0 == 0x1 then
                  dec a
                  jr  nz,zskip0156
                  jp     zscene2                                 ;0820 18 57	jump scene2
...
zscene1cont:        ld  iy, zenemydata1                          ;0824 ab db	i := enemydata1
                  ...
                  dec a
                  jr  nz,zskip0158
                  jp     zscene1                                 ;0836 17 92	jump scene1
...
zlabel0164:        ld  iy, zscene2SpriteData                     ;0869 ab 81	i := scene2SpriteData
                  ...
                  inc   iy
                  ld  a, $01                                     ;0875 71 01	v1 += 0x1
                  add  (ix+reg_v1)
                  ld	 (ix+reg_v1),a
                  ld  a,  (ix+reg_v1)                            ;0877 31 1e	if v1 != 0x1e then
                  cp  $1e
                  jr  z,zskip0165
                  jp     zlabel0164                              ;0879 18 69	jump label0164
...
zlabel0166:        ld  a,  (ix+reg_v1)                           ;087f 41 08	if v1 == 0x8 then
                  cp  $08
                  jr  nz,zskip0167
                  jp     zlabel0168                              ;0881 18 89	jump label0168
...
zskip0172:        ld  iy, zlevel2Objects                         ;08c5 ae 88	i := level2Objects
                  ...
                  cp  $05
                  jr  z,zskip0173
                  jp     zlabel0176                              ;08cb 18 ff	jump label0176
zskip0173:        ld  iy, zfuelflag                              ;08cd a8 50	i := fuelflag
                  ...
                  dec a
                  jr  z,zskip0174
                  jp     zlabel0175                              ;08db 18 fd	jump label0175
...
zlabel0176:        ld  a, c                                      ;08ff 30 03	if v0 != 0x3 then
                  cp  $03
                  jr  z,zskip0177
                  jp     zlabel0180                              ;0901 19 1d	jump label0180
zskip0177:        ld  iy, zkey1flag                              ;0903 a8 51	i := key1flag
                  ...
                  dec a
                  jr  z,zskip0178
                  jp     zlabel0179                              ;0911 19 1b	jump label0179
...
zlabel0180:        ld  a, c                                      ;091d 30 04	if v0 != 0x4 then
                  cp  $04
                  jr  z,zskip0181
                  jp     zlabel0184                              ;091f 19 3b	jump label0184
zskip0181:        ld  iy, zkey2flag                              ;0921 a8 52	i := key2flag
                  ...
                  dec a
                  jr  z,zskip0182
                  jp     zlabel0183                              ;092f 19 39	jump label0183
...
zlabel0184:        ld  a, c                                      ;093b 40 01	if v0 == 0x1 then
                  dec a
                  jr  nz,zskip0185
                  jp     zscene3                                 ;093d 19 6d	jump scene3
...
zscene2cont:        ld  iy, zenemydata1                          ;0941 ab db	i := enemydata1
                  ...
                  dec a
                  jr  nz,zskip0187
                  jp     zscene2                                 ;0953 18 57	jump scene2
zskip0187:        ld  iy, zenemydata2                            ;0955 ab ea	i := enemydata2
                  ...
                  dec a
                  jr  nz,zskip0188
                  jp     zscene2                                 ;0967 18 57	jump scene2
...
zlabel0190:        ld  iy, zscene3SpriteData                     ;0971 ab 9f	i := scene3SpriteData
                  ...
                  inc   iy
                  ld  a, $01                                     ;097d 71 01	v1 += 0x1
                  add  (ix+reg_v1)
                  ld	 (ix+reg_v1),a
                  ld  a,  (ix+reg_v1)                            ;097f 31 1e	if v1 != 0x1e then
                  cp  $1e
                  jr  z,zskip0191
                  jp     zlabel0190                              ;0981 19 71	jump label0190
...
zlabel0192:        ld  a,  (ix+reg_v1)                           ;0987 41 08	if v1 == 0x8 then
                  cp  $08
                  jr  nz,zskip0193
                  jp     zlabel0194                              ;0989 19 91	jump label0194
zskip0193:        ld  iy, zlevel3                                ;098b af 04	i := level3
...
zskip0198:        ld  b,$06                                      ;09cd 6f 06	vf := 0x6
                  ...
                  xor 1
                  ld  b,a
                  ld  a, b                                       ;09d1 4f 00	if vf == 0x0 then
                  or  a
                  jr  nz,zskip0199
                  jp     zscene3cont                             ;09d3 19 e7	jump scene3cont
zskip0199:        ld  a,  (ix+reg_v5)                            ;09d5 35 01	if v5 != 0x1 then
                  dec a
                  jr  z,zskip0200
                  jp     zscene3cont                             ;09d7 19 e7	jump scene3cont
zskip0200:        ld  iy, zlevel3Objects                         ;09d9 ae a9	i := level3Objects
                  ...
                  cp  $07
                  jr  nz,zskip0201
                  jp     zrocketHit                              ;09df 1a 13	jump rocketHit
zskip0201:        ld  a, c                                       ;09e1 40 01	if v0 == 0x1 then
                  dec a
                  jr  nz,zskip0202
                  jp     zscene4                                 ;09e3 1a 8b	jump scene4
...
zscene3cont:        ld  iy, zenemydata1                          ;09e7 ab db	i := enemydata1
                  ...
                  dec a
                  jr  nz,zskip0204
                  jp     zscene3                                 ;09f9 19 6d	jump scene3
zskip0204:        ld  iy, zenemydata2                            ;09fb ab ea	i := enemydata2
                  ...
                  dec a
                  jr  nz,zskip0205
                  jp     zscene3                                 ;0a0d 19 6d	jump scene3
...
zlabel0213:        ld  iy, zscene4SpriteData                     ;0a91 ab bd	i := scene4SpriteData
                  ...
                  inc   iy
                  ld  a, $01                                     ;0a9d 71 01	v1 += 0x1
                  add  (ix+reg_v1)
                  ld	 (ix+reg_v1),a
                  ld  a,  (ix+reg_v1)                            ;0a9f 31 1e	if v1 != 0x1e then
                  cp  $1e
                  jr  z,zskip0214
                  jp     zlabel0213                              ;0aa1 1a 91	jump label0213
...
zlabel0215:        ld  a,  (ix+reg_v1)                           ;0aa7 41 08	if v1 == 0x8 then
                  cp  $08
                  jr  nz,zskip0216
                  jp     zlabel0217                              ;0aa9 1a b1	jump label0217
zskip0216:        ld  iy, zlevel4                                ;0aab af 2e	i := level4
...
zskip0220:        ld  iy, zlevel4Objects                         ;0af3 ae b8	i := level4Objects
                  ...
                  dec a
                  jr  nz,zskip0221
                  jp     zendofgame                              ;0af9 1b 3d	jump endofgame
...
zlabel0222:        ld  iy, zenemydata1                           ;0afd ab db	i := enemydata1
                  ...
                  dec a
                  jr  nz,zskip0223
                  jp     zscene4                                 ;0b0f 1a 8b	jump scene4
zskip0223:        ld  iy, zenemydata2                            ;0b11 ab ea	i := enemydata2
                  ...
                  dec a
                  jr  nz,zskip0224
                  jp     zscene4                                 ;0b23 1a 8b	jump scene4
...
zskip0226:        ld  a, c                                       ;0b2f 50 30	if v0 != v3 then
                  cp  (ix+reg_v3)
                  jr  z,zskip0227
                  jp     zlabel0229                              ;0b31 1b 3b	jump label0229
zskip0227:        ld  a,  (ix+reg_v1)                            ;0b33 51 40	if v1 != v4 then
                  cp  (ix+reg_v4)
                  jr  z,zskip0228
                  jp     zlabel0229                              ;0b35 1b 3b	jump label0229
...
zscene1SpriteData:        
                        db 0x30, 0x0f, 0x00, 0x01, 0x00, 0x00, 0x28, 0x04, 0x00, 0x24, 0x0c, 0x00, 0x00, 0x00, 0x00		;0     (  $     
zinitEnemyData1:        
                        db 0x60, 0x08, 0x00, 0x01, 0x00, 0x00, 0x01, 0x28, 0x00, 0x24, 0x0c, 0x00, 0x00, 0x00, 0x00		;`      ( $     
zscene2SpriteData:        
                        db 0x2d, 0x15, 0x01, 0x00, 0x23, 0x46, 0x09, 0x1e, 0x00, 0x48, 0x0c, 0x00, 0x00, 0x00, 0x00, 0x60		;-   #F   H     `
                        db 0x08, 0x00, 0x01, 0x00, 0x7f, 0x08, 0x28, 0x00, 0x48, 0x0c, 0x00, 0x00, 0x00, 0x00		;     ( H     
zscene3SpriteData:        
                        db 0x45, 0x24, 0x01, 0x00, 0x40, 0x60, 0x09, 0x26, 0x00, 0x24, 0x0c, 0x00, 0x00, 0x00, 0x00, 0x30		;E$  @` & $     0
                        db 0x0a, 0x00, 0x01, 0x00, 0x80, 0x08, 0x28, 0x00, 0x24, 0x0c, 0x00, 0x00, 0x00, 0x00		;      ( $     
zscene4SpriteData:        
                        db 0x5a, 0x0a, 0x01, 0x01, 0x44, 0x6e, 0x01, 0x19, 0x00, 0x24, 0x0c, 0x00, 0x00, 0x00, 0x00, 0x1e		;Z   Dn   $      
                        db 0x05, 0x01, 0x01, 0x06, 0x32, 0x00, 0x15, 0x00, 0x24, 0x0c, 0x00, 0x00, 0x00, 0x00		;    2   $     
zenemydata1:            db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00		;               
zenemydata2:            db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00		;               
zsavedata:              db 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00		;               
ztemp:                  db 0x00		; 
...
zscenesprites:          db 0xaa	;█ █ █ █   
                        ...
                        db 0x00	;_______   
                        db 0x00	;_______   
zdata0248:              db 0x01, 0x03, 0x03, 0x07, 0x07, 0x07, 0x07, 0x07, 0x00, 0x80, 0x80, 0xc0, 0xc0, 0xc0, 0xc0, 0xc0		;                
                        db 0x07, 0x07, 0x06, 0x0c, 0x0c, 0x18, 0x18, 0x18, 0xc0, 0xc0, 0xc0, 0x60, 0x70, 0x30, 0x30, 0x30		;           `p000
...
zlevel1:                db 0xfe	;███████   
                        ...
                        db 0xff	;████████  
                        db 0xff	;████████  
zlevel1Objects:         db 0x05, 0x05, 0x00, 0x06, 0x05, 0x00, 0x0f, 0x05, 0x01, 0x09, 0x03, 0x02, 0x09, 0x05, 0x02, 0x0a		;                
                        db 0x03, 0x02, 0x0a, 0x05, 0x00, 0x0b, 0x05, 0x00, 0xff, 0xff, 0xff		;           
zlevel2Objects:         db 0x00, 0x03, 0x05, 0x01, 0x03, 0x05, 0x0e, 0x04, 0x04, 0x0f, 0x04, 0x04, 0x09, 0x02, 0x03, 0x09		;                
                        db 0x03, 0x03, 0x0a, 0x02, 0x03, 0x0a, 0x03, 0x03, 0x0f, 0x07, 0x01, 0x0f, 0x06, 0x01, 0xff, 0xff		;                
                        db 0xff		; 
zlevel3Objects:         db 0x0e, 0x06, 0x07, 0x0e, 0x05, 0x07, 0x0e, 0x02, 0x01, 0x0f, 0x02, 0x01, 0xff, 0xff, 0xff		;               
zlevel4Objects:         db 0x0f, 0x05, 0x01, 0x0f, 0x04, 0x01, 0xff, 0xff, 0xff		;         
